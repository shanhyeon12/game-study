...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        enemy.bottom = SPRITE_PIXEL_SIZE
        enemy.left = SPRITE_PIXEL_SIZE * 2
        ...
        enemy.bottom = SPRITE_PIXEL_SIZE * 4
        enemy.left = SPRITE_PIXEL_SIZE * 4
    ...
    def on_update(self, delta_time):
        ...
        if not self.game_over:
            ...
            for enemy in self.enemy_list:
                ...
                if len(arcade.check_for_collision_with_list(enemy, self.static_wall_list)) > 0:
                    enemy.change_x *= -1
